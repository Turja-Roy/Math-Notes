...
\Example{Determining Convergence}{
    Determine if the following sequences converge or diverge:
    \begin{enumerate}
        \item $\left\{ \dfrac{n^2}{2n^2 + 1} \right\}$
        \item $\left\{ \dfrac{(-1)^n}{n} \right\}$
        \item $\left\{ \dfrac{n!}{n^n} \right\}$
    \end{enumerate}
}
...
\Example{Bounded Sequences}{
    Determine if the following sequences are bounded:
    \begin{enumerate}
        \item $\left\{ \dfrac{\sin(n)}{n} \right\}$
        \item $\left\{ (-1)^n n \right\}$
        \item $\left\{ \dfrac{2n}{n+1} \right\}$
    \end{enumerate}
}
...
\Note[Looking Ahead]{
    Sequences form the foundation for understanding \textbf{series}. While a sequence is simply a list of numbers, a series is the sum of the terms of a sequence. In the next section, we will explore infinite series and develop tests to determine whether such sums converge to a finite value.
}
